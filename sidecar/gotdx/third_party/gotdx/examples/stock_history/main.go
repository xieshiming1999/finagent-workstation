...
func main() {
	...
	tickItems, err := client.StockHistoryTickChart(20260316, types.MarketSZ.Uint8(), "000001")
	if err != nil {
		log.Fatalln(err)
	}
	...
	transItems, err := client.StockHistoryTransaction(20260316, types.MarketSZ.Uint8(), "000001", 0, 20)
	if err != nil {
		log.Fatalln(err)
	}
