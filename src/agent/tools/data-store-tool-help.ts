...
Query local data:
  ...
  query_market_screening, query_technical_indicator, query_alpha_factors, query_raw_payload, query_api_calls, interfaces, interface_describe, interface_availability, coverage, reusable_summary, data_health, finance_doctor, data_feeds, runtime_probe, stock_list
